...
<html lang="en">
    ...
    <body>
        <!-- Header -->
        <h1 class="text-center py-3">Status</h1>
        <?php
            session_start();
        ...
        <?php
            ...
            $sql = "SELECT d.item_id, d.item_quantity, i.item_name, o.order_status
                            ...
                            <div class="card-body">
                                <div class="row pb-1">
                                    ...
                                    <div class="col-4 d-flex justify-content-end align-items-center">
                                        <span class="badge ' . ($row["order_status"] == 'Pending' ? 'bg-warning' : 'bg-success') . '">
                                            <h5>' . $row["order_status"] . '</h5>
                                        </span>
                                    </div>
                                </div>
        ...
        ?>
        <hr class="mx-3">
        <button type="button" class="btn btn-primary mx-3" id="checkoutBtn" data-bs-toggle="modal" data-bs-target="#checkoutModal">Checkout</button>
        <hr class="mx-3 mb-5">
        <!-- Checkout Modal -->
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Request bill from staff? You will not be able to access the menu anymore after clicking proceed.</p>
                        <div class="d-flex">
                        <a class="btn btn-primary" href="end.php" role="button">Proceed</a>
                            <button type="button" class="btn btn-secondary ms-2" data-bs-dismiss="modal">Back</button>
                        </div>
                    </div>
                </div>
            </div>
