...
const item1 = new Item("Sample Item 1", "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas sed quas fuga alias natus exercitationem ad porro, magnam sit veniam in asperiores eaque.",
 500, "Sample Category 1")
const item2 = new Item("Sample Item 2", "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas sed quas fuga alias natus exercitationem ad porro, magnam sit veniam in asperiores eaque.",
 300, "Sample Category 1")
const item3 = new Item("Sample Item 3", "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas sed quas fuga alias natus exercitationem ad porro, magnam sit veniam in asperiores eaque.",
 250, "Sample Category 2")
const item4 = new Item("Sample Item 4", "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas sed quas fuga alias natus exercitationem ad porro, magnam sit veniam in asperiores eaque.",
 400, "Sample Category 2")
const item5 = new Item("Sample Item 5", "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas sed quas fuga alias natus exercitationem ad porro, magnam sit veniam in asperiores eaque.",
 500, "Sample Category 3")
...
function updateTotalPrice() {
    const totalPrice = parseInt(itemPrice.textContent) * parseInt(amountInput.value);
